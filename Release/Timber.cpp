...
int main()
{
	...
	sf::RenderWindow window(vm, "Lumberjack", Style::Default);
	...
	//std::cout << "textRect.left :" << textRect.left << "\n";
	//std::cout << "textRect.width :" << textRect.width << "\n";
	//std::cout << "textRect.top :" << textRect.top << "\n";
	//std::cout << "textRect.height :" << textRect.height << "\n";
	//std::cout << "\n";
		...
		*/
		...
		if (acceptInput)
		{
			...
			if (Keyboard::isKeyPressed(Keyboard::Right))
			{
				...
				//spriteAxe.scale(-1, 1); //ALWAYS FLIP
			...
			if (Keyboard::isKeyPressed(Keyboard::Left))
			{
				...
				//spriteAxe.scale(1, 1); //DOESNT FLIP
		...
		*/
		...
		if (paused == false) 
		{
			...
			if (flagActive == false)
			{
				...
				spriteFlag.setPosition(-200, height);
				flagActive = true;
			}
			else
			{
				spriteFlag.setPosition(
					spriteFlag.getPosition().x +
					(flagSpeed * dt.asSeconds()),
					spriteFlag.getPosition().y);

				if (spriteFlag.getPosition().x > 1920)
				{
					flagActive = false;
				}
			}
